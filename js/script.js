...
function completedCB() {
   todoArray.forEach(function (arrayObj)  {
      if (!arrayObj.active && arrayObj.DOMelem.classList.contains("hidden")) {
         arrayObj.DOMelem.classList.remove("hidden");
      }
      else if (arrayObj.active && !arrayObj.DOMelem.classList.contains("hidden")) {
         arrayObj.DOMelem.classList.add("hidden");      
   }
});
}
...
function allCB() {
   todoArray.forEach(function (arrayObj)  {
      if (arrayObj.DOMelem.classList.contains("hidden")) {
         arrayObj.DOMelem.classList.remove("hidden");
      }
   });
...
function activeCB() {
   todoArray.forEach(function (arrayObj)  {
      ...
      else if (arrayObj.active === false && !arrayObj.DOMelem.classList.contains("hidden")) {
         arrayObj.DOMelem.classList.add("hidden");
